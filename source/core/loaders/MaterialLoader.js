...
MaterialLoader.prototype.parse = function (json) {
  ...
  if (json.type == 'ShaderMaterial') {
    ...
    console.log('ShaderMaterial', json);
    return;
  }
  ...
  //glossiness
  if (json.glossiness !== undefined) {
    material.glossiness = json.glossiness;
  }

  if (json.glossinessMap !== undefined) {
    material.glossinessMap = getTexture(material.glossinessMap);
  }
  if (json.isGLTFSpecularGlossinessMaterial !== undefined) {
    material.isGLTFSpecularGlossinessMaterial = json.isGLTFSpecularGlossinessMaterial;
  }
