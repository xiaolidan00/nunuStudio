...
LocaleManager.register({
  ...
  render: 'Render',
  tools: 'Tools',
  selectShortcut: 'Select (Q)',
  moveShortcut: 'Move (W)',
  scaleShortcut: 'Scale (E)',
  rotateShortcut: 'Rotate (R)',
  about: 'About',
  search: 'Search',
  replace: 'Replace',
  ...
  failedLoadSpine:
    'Failed to load Spine animation, make sure that .json and .atlas have the same name.',

  //Hints renderer
  hintStencil: 'Whether the drawing buffer has a stencil buffer of at least 8 bits.',
  hintSortObjects:
    'If true the renderer sorts the objects from back to front for rendering. Important if using multiple transparent objects.',
  ...
  hintBackend:
    'Prefered redering backend API to use if available. Shader code might not be cross compatible between rendering backends.',
  hintPremultipliedAlpha: 'Whether the renderer will assume that colors have premultiplied alpha.',
  hintLogarithmicDepthBuffer:
